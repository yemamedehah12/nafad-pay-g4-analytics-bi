...
-- Ligne dummy pour les transactions sans utilisateur connu
INSERT INTO dim_user (user_key, user_id, full_name, status, is_current)
OVERRIDING SYSTEM VALUE VALUES (-1, -1, 'Sans utilisateur', 'N/A', TRUE);
